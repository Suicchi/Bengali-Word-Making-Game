...
namespace ban_u2a
{
    ...
    public class UniToBijoy
    {
        ...
        public UniToBijoy()
        {
            ar = JsonConvert.DeserializeObject<Dictionary<string, string>>(File.ReadAllText(Application.streamingAssetsPath + "/ar.json"));
            aR = JsonConvert.DeserializeObject<Dictionary<string, string>>(File.ReadAllText(Application.streamingAssetsPath + "/aRR.json"));
            aM = JsonConvert.DeserializeObject<Dictionary<string, string>>(File.ReadAllText(Application.streamingAssetsPath + "/aM.json"));
            aS = JsonConvert.DeserializeObject<Dictionary<string, string>>(File.ReadAllText(Application.streamingAssetsPath + "/aS.json"));
        }
        string ci(string w)
        {
            var cY = 0;
